...
2. Appelle \`search_facts\` avec \`query: "${ticket.summary}"\` et \`group_id: "${config.projectKey}"\`

Utilise ces resultats comme contexte. Ne lis PAS les fichiers source pour comprendre l'architecture — la memoire contient deja cette information. Lis UNIQUEMENT les fichiers que tu dois modifier.
...
Apres chaque commit, appelle \`add_episode\` avec :
